...
4. **Next:** Gig-card small photo + Launch Feed 20-app smoke, then dummy deletes.
   See `docs/V1_HARDENING_TASKLIST.md`. Native may start on the live Firebase backend.
