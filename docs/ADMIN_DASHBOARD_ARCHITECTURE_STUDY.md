...
| Ad Placement | One `adSettings/global` doc (public read, admin write). Config `.get()` only — no listener, no impression writes. | Phase 6 Ch 1–4 built 2026-08-18 — waiting Deploy + owner test |
