...
const SIGNUP_I18N = {
  english: {
    ...
    oauthHint: 'Skip making a password if you already use Facebook or Google.',
    or: 'OR',
    phonePasswordSignup: 'Sign Up with Phone & Password',
    phonePasswordHint: 'Use your phone number and a password. It works on every phone.',
    createPassword: 'Create a Password',
    createPasswordHint: "You'll sign in with your phone number and this password.",
  ...
  bisaya: {
    ...
    oauthHint: 'Laktawi ang paghimo og password kung naggamit ka na og Facebook o Google.',
    or: 'O',
    phonePasswordSignup: 'Mag-Sign Up gamit ang Phone & Password',
    phonePasswordHint: 'Gamita ang imong phone number ug usa ka password. Molihok ni sa tanang phone.',
    createPassword: 'Paghimo og Password',
    createPasswordHint: 'Mo-sign in ka gamit ang imong phone number ug kini nga password.',
    passwordLabel: 'Password *',
  ...
  tagalog: {
    ...
    oauthHint: 'Laktawan ang paggawa ng password kung gumagamit ka na ng Facebook o Google.',
    or: 'O',
    phonePasswordSignup: 'Mag-Sign Up gamit ang Phone & Password',
    phonePasswordHint: 'Gamitin ang iyong phone number at isang password. Gumagana sa bawat phone.',
    createPassword: 'Gumawa ng Password',
    createPasswordHint: 'Mag-si-sign in ka gamit ang iyong phone number at password na ito.',
    passwordLabel: 'Password *',
